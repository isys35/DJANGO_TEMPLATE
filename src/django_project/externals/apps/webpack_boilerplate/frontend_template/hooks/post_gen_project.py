...
def update_webpack_path():
    ...
    with open(file_path, "r+") as f:
        file_contents = f.read().replace("--config webpack/", "--config {{ cookiecutter.project_slug }}/webpack/")
        f.seek(0)
...
def main():
    ...
    print_success_msg(
        "Frontend app "
        "has been created. "
        "To know more, check https://python-webpack-boilerplate.rtfd.io/en/latest/frontend/"
    )
